...
public class RegisterConfirmationEndpointHandler extends UserRequestHandler {
    ...
    public RegisterConfirmationEndpointHandler(UserService userService) {
    ...
    public void handle(RoutingContext context) {
        ...
        userService.confirmRegistration(user)
                .subscribe(
                        () -> redirectToPage(context, "success", "registration_completed"),
                        error -> redirectToPage(context, "error", "registration_failed"));
