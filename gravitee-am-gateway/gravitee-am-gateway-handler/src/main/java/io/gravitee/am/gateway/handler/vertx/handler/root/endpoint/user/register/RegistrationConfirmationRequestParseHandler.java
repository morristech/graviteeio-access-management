 ...
 */
public class RegistrationConfirmationRequestParseHandler extends UserTokenRequestParseHandler {

    public RegistrationConfirmationRequestParseHandler(UserService userService) {
        super(userService);
    }
}
