...
import io.gravitee.am.gateway.handler.vertx.handler.root.endpoint.user.register.RegisterConfirmationEndpointHandler;
import io.gravitee.am.gateway.handler.vertx.handler.root.endpoint.user.register.RegisterConfirmationRequestParseHandler;
import io.gravitee.am.gateway.handler.vertx.handler.root.endpoint.user.register.RegistrationConfirmationEndpointHandler;
import io.gravitee.am.gateway.handler.vertx.handler.root.endpoint.user.register.RegistrationConfirmationRequestParseHandler;
...
public class RootRouter {
    ...
    public Router route(AuthProvider userAuthProvider) {
        ...
        Handler<RoutingContext> registrationRequestParseHandler = new RegistrationConfirmationRequestParseHandler(userService);
        ...
        Handler<RoutingContext> registerHandler = new RegisterConfirmationEndpointHandler(userService);
